...
def compPlayHand(hand, wordList, n):
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the word is valid):
            ...
            print str('\"' + word + '\" earned ' + str(points) + ' points.'),
            print str('Total: ' + str(score) + ' points\n')
            # Update the hand 
            hand = updateHand(hand,word)
    # Game is over (no more words or ran out of letters), so tell user the total score
    print str('Total score: ' + str(score) + ' points.')
